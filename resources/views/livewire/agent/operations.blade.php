            ...
            @if($ciStep === 'lookup')
                <div>
                    ...
                    <button wire:click="lookupCustomer" wire:loading.attr="disabled" type="button"
                        ...
                        <span wire:loading.flex wire:target="lookupCustomer" style="display:none;align-items:center;gap:8px;">
                            <x-spinner :size="16" />
                            Recherche en cours…
                        </span>
                    </button>
            ...
            @elseif($ciStep === 'amount')
                <div>
                    ...
                    <button wire:click="submitCashIn" wire:loading.attr="disabled" type="button"
                        ...
                        <span wire:loading.flex wire:target="submitCashIn" style="display:none;align-items:center;gap:8px;">
                            <x-spinner :size="16" />
                            Traitement…
                        </span>
                    </button>
            ...
            @if($coStep === 'form')
                <div>
                    ...
                    <button wire:click="lookupMerchant" wire:loading.attr="disabled" type="button"
                        ...
                        <span wire:loading.flex wire:target="lookupMerchant" style="display:none;align-items:center;gap:8px;">
                            <x-spinner :size="16" />
                            Vérification…
                        </span>
                    </button>
            ...
            @elseif($coStep === 'confirm')
                <div>
                    ...
                    <button wire:click="submitCashOut" wire:loading.attr="disabled" type="button"
                        ...
                        <span wire:loading.flex wire:target="submitCashOut" style="display:none;align-items:center;gap:8px;">
                            <x-spinner :size="16" />
                            Traitement…
                        </span>
                    </button>
