...
<div class="app-shell" style="height:100dvh; max-width:1280px; margin:0 auto;">
    ...
    {{-- Main content --}}
    <main class="app-main">
        {{-- Top bar for the current page (shown on tablet+ at top of content area) --}}
        <div style="display:flex;align-items:center;height:56px;padding:0 20px;background:var(--surface);border-bottom:1px solid var(--border-color);flex-shrink:0;" class="app-top-bar">
        ...
        <nav class="app-bottom-nav" style="background:var(--surface);border-top:1px solid var(--border-color);height:64px;padding-bottom:env(safe-area-inset-bottom);">
            @php
                $bottomTabs = [
                    ...
                    ['route' => 'profile',     'label' => 'Profil',      'icon' => 'profile'],
                ];
            @endphp
